...
export default function POS() {
  ...
  if (receipt) return (
    <div className="pos-page"><div className="receipt-overlay"><div className="receipt-card">
      ...
      <div className="receipt-row"><span>Method</span><span className={`method-tag method-tag--${receipt.method === "Cash" ? "cash" : receipt.method === "Tuma" || receipt.method === "M-Pesa" ? "m-pesa" : "split"}`}>{receipt.method}</span></div>
